(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8444,5242,371,7592],{4033:function(e,r,n){e.exports=n(94)},1393:function(e,r,n){"use strict";n.d(r,{M:function(){return AnimatePresence}});var l=n(7437),d=n(2265),c=n(781),f=n(961),h=n(538),g=n(8243),y=n(5968);let PopChildMeasure=class PopChildMeasure extends d.Component{getSnapshotBeforeUpdate(e){let r=this.props.childRef.current;if(r&&e.isPresent&&!this.props.isPresent){let e=r.offsetParent,n=e instanceof HTMLElement&&e.offsetWidth||0,l=this.props.sizeRef.current;l.height=r.offsetHeight||0,l.width=r.offsetWidth||0,l.top=r.offsetTop,l.left=r.offsetLeft,l.right=n-l.width-l.left}return null}componentDidUpdate(){}render(){return this.props.children}};function PopChild({children:e,isPresent:r,anchorX:n}){let c=(0,d.useId)(),f=(0,d.useRef)(null),h=(0,d.useRef)({width:0,height:0,top:0,left:0,right:0}),{nonce:g}=(0,d.useContext)(y._);return(0,d.useInsertionEffect)(()=>{let{width:e,height:l,top:d,left:y,right:b}=h.current;if(r||!f.current||!e||!l)return;let v="left"===n?`left: ${y}`:`right: ${b}`;f.current.dataset.motionPopId=c;let w=document.createElement("style");return g&&(w.nonce=g),document.head.appendChild(w),w.sheet&&w.sheet.insertRule(`
